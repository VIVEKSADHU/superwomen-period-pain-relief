...
const bonuses = [
  {
    ...
    description: 'Track your symptoms, mood, and energy levels to find patterns and celebrate your body’s cycle. (Value: ₹499)',
  },
  {
    title: 'The ‘When Cramps Are NOT Normal’ Checklist',
    description: 'Know the critical signs that mean it’s time to see a doctor. This checklist helps you prepare for your visit and ask the right questions. (Value: ₹299)',
  },
];
          ...
          <div className="relative z-10">
            <div className="text-center">
              <h2 className="font-headline text-3xl font-bold tracking-tight text-accent-foreground sm:text-4xl">
                Plus, Get These FREE Bonuses (Worth ₹999)
              </h2>
              ...
              <Card className="h-full">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <CardTitle>AI-Powered 7-Day Gentle Yoga Plan</CardTitle>
                  </div>
                  <CardDescription>
                    Your personal, printable yoga schedule generated by AI to specifically target your symptoms. (Value: ₹199)
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <p className="mt-12 text-center text-md font-semibold text-accent-foreground/80">
              Get the guide and all bonuses today for a single, one-time payment of ₹199.
            </p>
          </div>
        </div>
      </div>
