        ...
        <div className="relative rounded-lg bg-accent p-8 md:p-12 lg:p-16 overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="mt-12 grid gap-8 lg:grid-cols-2 lg:items-start">
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardDescription>
                    Your personal, printable yoga schedule generated by AI to specifically target your symptoms. (Value: Rs.199)
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <p className="mt-12 text-center text-md font-semibold text-accent-foreground/80">
              Get the guide and all bonuses today for a single, one-time payment of Rs.199.
            </p>
          </div>
        </div>
      </div>
