    ...
    <section id="free-offer" className="bg-secondary py-20 sm:py-24">
      <div className="container text-center">
        <div className="bg-card rounded-lg p-8 md:p-12 max-w-2xl mx-auto shadow-xl">
          <h3 className="font-headline text-2xl font-bold text-foreground">First, Try The Emergency Relief Kit. It's FREE.</h3>
          <p className="mt-4 mb-8 text-lg text-muted-foreground">
            Experience the relief for yourself. This 1-page guide gives you the exact steps to calm severe cramps in under 5 minutes. No fluff, just fast comfort. It's my gift to you.
          </p>
