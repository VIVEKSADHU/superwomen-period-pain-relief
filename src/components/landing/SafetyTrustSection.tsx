...
const safetyPoints: SafetyPoint[] = [
  {
    ...
    description: 'Every technique is based on gentle, holistic principles. No pills, no side-effects, just your body’s natural ability to find comfort.',
    Icon: ShieldCheck,
  },
  {
    title: 'Doctor-Aware & Responsible',
    description: 'This guide complements medical advice, it doesn’t replace it. You’ll even get a checklist to help you know when it’s time to see a professional.',
    Icon: ThumbsUp,
  },
  {
    title: '30-Day Money-Back Guarantee',
    description: 'Try the complete guide for a full cycle. If you don’t feel a noticeable difference, email me for a full, no-questions-asked refund.',
    Icon: CheckCircle,
  },
];
      ...
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            I’m confident this guide will help you. But your peace of mind comes first.
          </p>
        </div>
